...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.aveekpatra.speek", category: "LogExporter")
    private let subsystem = "com.aveekpatra.speek"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Speek Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Speek Logs \(timestamp).log"
