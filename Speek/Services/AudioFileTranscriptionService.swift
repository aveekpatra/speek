...
class AudioTranscriptionService: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.aveekpatra.speek", category: "AudioTranscriptionService")
    ...
    init(modelContext: ModelContext, engine: SpeekEngine) {
    ...
    func retranscribeAudio(from url: URL, using model: any TranscriptionModel, mode: ModeConfig? = nil) async throws -> Transcription {
        ...
        do {
            ...
            let recordingsDirectory = SpeekSettings.recordingsDirectory
