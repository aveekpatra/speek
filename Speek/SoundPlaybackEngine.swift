...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.aveekpatra.speek.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.aveekpatra.speek", category: "SoundPlaybackEngine")
