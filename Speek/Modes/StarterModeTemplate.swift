...
enum StarterModeCatalog {
    static let templates: [StarterModeTemplate] = [
        StarterModeTemplate(
            ...
            description: "Local transcription, cleaned up on device by S1-mini.",
            guidance: "Fillers, stutters and false starts are removed, corrections are resolved, and punctuation is fixed. Your wording stays yours.",
        ...
        StarterModeTemplate(
            ...
            guidance: "Use this after selecting relevant text or opening the related window. Speek uses that context to shape a clear email draft.",
        ...
        StarterModeTemplate(
            ...
            guidance: "Use this for answers, summaries, and follow-ups. Instead of pasting, Speek keeps the conversation inside the recorder.",
