...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.aveekpatra.speek", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.aveekpatra.speek.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.aveekpatra.speek.audioSetup", qos: .userInitiated)
