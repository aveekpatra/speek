...
# rebuilds. Import ~/WhisperPro-Dependencies/speek-dev-signing/speek-dev.p12 into the
...
xcodebuild -project "Whisper Pro.xcodeproj" -scheme "Whisper Pro" -configuration Debug \
  ...
  ENABLE_DEBUG_DYLIB=NO CODE_SIGN_ENTITLEMENTS="$PWD/Whisper Pro/WhisperPro.local.entitlements" \
